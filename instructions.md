...
**Step 9**. Click Create Document once the client matter name appears correctly in the box.

**Step 10**. Once created, the document will pop-up as a downloadable file on your computer.

**Step 11**. Open the file and save it onto your computer using MS Word software.

**Step 12**. Save your file download in this format: last name, first name, middle initial, template type, year created.
